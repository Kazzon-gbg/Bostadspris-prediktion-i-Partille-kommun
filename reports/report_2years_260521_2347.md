...
bostadsförsäljningar från perioden **2024-05-20 till 2026-05-18**.
...
Den bästa modellen i denna körning blev **Gradient Boosting log-target**.

- **MAE:** 710 711 kr (0.71 MSEK)
- **RMSE:** 1 030 689 kr (1.03 MSEK)
- **R²:** 0.689
- **MAPE:** 11.3 %
...
- Datafil: `data/partille_housing_real_last_2_years.csv`
- Datumintervall: **2024-05-20 till 2026-05-18**
- Antal rader efter grundstädning: **599**
- Antal kolumner efter feature engineering: **47**
- Rader med beräknat eller tillgängligt utgångspris: **335**
...
- Medianpris: **6 027 000 kr**
- Genomsnittspris: **6 197 159 kr**
...
month                                 0
final_price_sek                       0
asking_price_sek                    264
price_change_sek                    264
price_change_percent                264
living_area_m2                       40
extra_area_m2                       216
rooms                               110
plot_area_m2                         46
price_per_m2                         40
bid_change_percent                  264
source_url                            0
detail_url                            0
build_year                            0
energy_class                        599
operating_cost_sek_per_year         599
monthly_fee_sek                     565
ownership_type                      599
latitude                              0
longitude                             0
...
|---|---:|---:|---:|---:|
| Gradient Boosting log-target | 710 711 | 1 030 689 | 0.689 | 11.3 % |
| Random Forest log-target | 700 742 | 1 054 690 | 0.674 | 11.0 % |
| Linear Regression log-target | 816 522 | 1 137 669 | 0.621 | 13.1 % |
| Decision Tree log-target | 870 740 | 1 221 806 | 0.563 | 13.6 % |

Den bästa modellen blev **Gradient Boosting log-target** baserat på lägst RMSE.
...
För den bästa modellen är MAPE **11.3 %**. Det betyder att
