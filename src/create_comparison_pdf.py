...
"""
Skapar en jämförelserapport i Markdown och PDF för modellresultat från 1, 2 och 3 års data.

Observera att scriptet inte tränar modeller och inte hämtar modellresultat automatiskt.
Resultaten är manuellt inlagda i SUMMARY_ROWS och MODEL_ROWS efter separata
modellkörningar.

Scriptets uppgift är att visualisera och sammanfatta redan framtagna resultat.
